...
export const LEGAL_DOCUMENTS: Record<LegalDocId, LegalDocument> = {
  ...
  kvkk: {
    ...
    updatedLabel: "Son güncelleme: 31 Ağustos 2026",
    paragraphs: [
      "Veri sorumlusu: [İŞLETME UNVANI – DOLDURULACAK], bkz. /hizmet-saglayici-bilgileri. Bu metin, 6698 sayılı Kişisel Verilerin Korunması Kanunu’nun 10. maddesi uyarınca hazırlanmıştır.",
  ...
  provider: {
    ...
    updatedLabel: "Son güncelleme: 31 Ağustos 2026",
    paragraphs: [
      "Unvan / Ad-Soyad: [İŞLETME UNVANI – DOLDURULACAK]",
      "Açık adres: [ADRES – DOLDURULACAK]",
      "MERSİS No (varsa) / Vergi No: [MERSİS/VERGİ NO – DOLDURULACAK]",
      "E-posta: [E-POSTA – DOLDURULACAK]",
      "Telefon: [TELEFON – DOLDURULACAK]",
