...
export const LEGAL_DOCUMENTS: Record<LegalDocId, LegalDocument> = {
  ...
  kvkk: {
    ...
    updatedLabel: "Son güncelleme: 31 Ağustos 2026",
    paragraphs: [
      "Veri sorumlusu: İsmail Simpil, bkz. /hizmet-saglayici-bilgileri. Bu metin, 6698 sayılı Kişisel Verilerin Korunması Kanunu’nun 10. maddesi uyarınca hazırlanmıştır.",
  ...
  provider: {
    ...
    paragraphs: [
      ...
      "Açık adres: BOYUNLU KÜME EVLER KAPI NO. 264 ZEMİN, BOYUNLU MAHALLESİ, SİLVAN / DİYARBAKIR",
      "MERSİS No (varsa) / Vergi No: [MERSİS/VERGİ NO – DOLDURULACAK]",
      "E-posta: arkeolog871@gmail.com",
      "Telefon: 0 (546) 696 31 33",
